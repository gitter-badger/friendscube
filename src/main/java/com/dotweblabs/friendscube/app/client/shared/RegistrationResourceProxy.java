...
public interface RegistrationResourceProxy extends ClientProxy {
    ...
    static final String REGISTRATIONS_URI = "registrations";

    @Get
    public void retrieve(Result<Registration> callback);
    @Post
    public void store(Registration registration, Result<Void> callback);
    @Delete
    public void remove(Result<Void> callback);
    @Post
    public void resetPassword(String newPassword, Result<Void> callback);
