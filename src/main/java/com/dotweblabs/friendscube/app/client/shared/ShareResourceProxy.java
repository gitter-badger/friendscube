 ...
 * @since 1.0
 */
public interface ShareResourceProxy extends ClientProxy {

    static final String REGISTRATIONS_URI = "/shares";

    @Get
    public void retrieve(Result<Share> callback);

    @Post
    public void store(Share share, Result<Void> callback);
