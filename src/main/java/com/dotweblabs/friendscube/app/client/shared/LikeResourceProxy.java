 ...
 * @since 1.0
 */
public interface LikeResourceProxy extends ClientProxy {

    static final String LIKES_URI = "likes";

    @Get
    public void retrieve(Result<Like> callback);
    @Post
    public void store(Like like, Result<Void> callback);
    @Delete
