...
*/
package com.dotweblabs.friendscube.app.client.shared.entity.search;
 ...
 * @since 1.0
 */
public class ProfileSearchItem extends SearchItem<Profile>{
    ...
    public ProfileSearchItem(Profile profile){
        model = profile;
