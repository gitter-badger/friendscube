...
public class Share {
    ...
    @Id
    private Long id;
    @ApiModelProperty(value = "ID of item being shared. A Status, a Group or a Page")
    private Long itemId;
    private String itemType;
    @ApiModelProperty(value = "ID of User that sends the share")
    private Long userId;
    @ApiModelProperty(value = "ID of user that receives the share")
