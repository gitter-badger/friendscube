 ...
 * @since 1.0
 */
public interface MessageResourceProxy extends ClientProxy {

    static final String MESSAGES_URI = "messages";

    @Get
    public void retrieve(Result<MessagesList> callback);

    @Post
    public void store(Message message, Result<Message> callback);
