...
import com.dotweblabs.friendscube.rest.resources.NotificationsResource;
 ...
 * @since 1.0
 */
public class GaeNotificationsServerResource extends SelfInjectingServerResource
    ...
    public Notifications listNotifications(Long userId) {
        return notificationService.listNotifications(Long.valueOf(this.getRequestAttributes().get("user_id").toString()));
    }
}
