...
import com.dotweblabs.friendscube.rest.resources.RequestActionResource;
 ...
 * @since 1.0
 */
public class GaeRequestActionServerResource extends SelfInjectingServerResource
        implements RequestActionResource {
    ...
    public void newRequest(Request request) {
        requestActionService.create(request);
        setStatus(Status.SUCCESS_OK);
    }

    @Override
    public void respondRequest(Request type) {
