...
import com.dotweblabs.friendscube.rest.resources.UserProfilesResource;
 ...
 * @since 1.0
 */
public class GaeUserProfilesServerResource extends SelfInjectingServerResource
    ...
    public SearchItems findProfiles(String query) {
        ...
        return profileService.findProfiles(getQueryValue("query"));
    }
}
