...
import com.dotweblabs.friendscube.rest.resources.FriendsResource;
 ...
 * @since 1.0
 */
public class GaeFriendsServerResource extends SelfInjectingServerResource
    implements FriendsResource {
    ...
    public Friends listFriends(Long userId) {
        getLogger().info("getting friends...");
        Friends friends = friendService.listFriends(Long.valueOf(this.getRequestAttributes().get("user_id").toString()));
        return friends;
    }
}
