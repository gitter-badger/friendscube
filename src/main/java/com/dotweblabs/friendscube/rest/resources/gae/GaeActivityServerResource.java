...
import com.dotweblabs.friendscube.rest.resources.ActivityResource;
 ...
 * @since 1.0
 */
public class GaeActivityServerResource extends SelfInjectingServerResource
    ...
    public Activity getActivity(Long activityId) {
        return activityService.getActivity(Long.valueOf(this.getRequestAttributes().get("activity_id").toString()));
    }
